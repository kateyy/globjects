...
public:
    virtual void initialize(glowwindow::Window & window) override {
		...
		glow::Shader* vertexShader = glow::Shader::fromFile(gl::VERTEX_SHADER, "data/transparency/transparency.vert");
        ...
        quadProgram->attach(glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/transparency/quad.frag"));
        quadProgram->attach(glow::Shader::fromFile(gl::VERTEX_SHADER, "data/transparency/quad.vert"));
