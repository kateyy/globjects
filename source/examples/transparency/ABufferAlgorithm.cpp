...
void ABufferAlgorithm::initialize(const std::string & transparencyShaderFilePath, glow::Shader *vertexShader, glow::Shader *geometryShader) {
	...
	m_program->attach(glow::Shader::fromFile(gl::FRAGMENT_SHADER, transparencyShaderFilePath +  "abuffer.frag"));
	...
	m_quad = new glowutils::ScreenAlignedQuad(glow::Shader::fromFile(gl::FRAGMENT_SHADER, transparencyShaderFilePath +  "abuffer_post.frag"));
