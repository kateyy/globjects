...
void TransformFeedbackParticles::initialize()
{
    ...
    m_transformFeedbackProgram->attach(glow::Shader::fromFile(gl::VERTEX_SHADER, "data/gpu-particles/transformfeedback.vert"));
    ...
    m_drawProgram->attach(
        glow::Shader::fromFile(gl::VERTEX_SHADER, "data/gpu-particles/points.vert")
    ,   glow::Shader::fromFile(gl::GEOMETRY_SHADER, "data/gpu-particles/points.geom")
    ,   glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/gpu-particles/points.frag"));
    ...
    m_clear = new glowutils::ScreenAlignedQuad(
        glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/gpu-particles/clear.frag"));
}
