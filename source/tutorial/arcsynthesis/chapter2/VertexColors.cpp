...
protected:
    ...
    void initializeProgram () {
		...
		theProgram->attach(
                           glow::Shader::fromFile(gl::VERTEX_SHADER, "data/arcsynthesis/chapter2/vertex-colors.vert"),
                           glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/arcsynthesis/chapter2/vertex-colors.frag")
                           );
    }
