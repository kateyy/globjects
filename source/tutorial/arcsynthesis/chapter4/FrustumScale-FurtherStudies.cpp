...
protected:
    ...
    void initializeProgram () {
		...
		theProgram->attach(
                           glow::Shader::fromFile(gl::VERTEX_SHADER, "data/arcsynthesis/chapter4/shader-perspective.vert"),
                           glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/arcsynthesis/chapter4/shader-perspective.frag")
                           );
        ...
        theProgram->use();
//        theProgram->setUniform(frustumScaleUniform->name(), 0.1f);
//        theProgram->setUniform(frustumScaleUniform->name(), 0.25f);
        theProgram->setUniform(frustumScaleUniform->name(), 0.5f);
//        theProgram->setUniform(frustumScaleUniform->name(), -0.5f);
...
int main(int /*argc*/, char* /*argv*/[]) {
    ...
    if (window.create(format, "Learning Modern 3D Graphics Programming [with glow] -- Frustum Scale [Shader Perspective]")) {
