...
protected:
    ...
    void initializeProgram () {
		...
		theProgram->attach(
                           glow::Shader::fromFile(gl::VERTEX_SHADER, "data/arcsynthesis/chapter4/ortho-cube.vert"),
                           glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/arcsynthesis/chapter4/ortho-cube.frag")
                        );
