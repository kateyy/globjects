...
//        theProgram->setUniform(zNearUniform->name(), 1.0f);
        theProgram->setUniform(zNearUniform->name(), 1.5f);
//        theProgram->setUniform(zFarUniform->name(), 3.0f);
        theProgram->setUniform(zFarUniform->name(), 2.0f);
        theProgram->release();
    }
...
int main(int /*argc*/, char* /*argv*/[]) {
    ...
    if (window.create(format, "Learning Modern 3D Graphics Programming [with glow] -- ZFar/ZNear Change [Shader Perspective]")) {
