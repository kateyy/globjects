...
//        CheckGLError();
         ...
         */
        vao->drawArrays(gl::TRIANGLES, 3, 6);
...
protected:
    ...
    void initializeProgram () {
		...
		theProgram->attach(
                           glow::Shader::fromFile(gl::VERTEX_SHADER, "data/arcsynthesis/chapter3/vert-calc-offset-further-studies.vert"),
                           glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/arcsynthesis/chapter3/vert-calc-offset-further-studies.frag")
                        );
