...
protected:
    ...
    void initializeProgram () {
		...
		theProgram->attach(
                           glow::Shader::fromFile(gl::VERTEX_SHADER, "data/arcsynthesis/chapter3/calc-color.vert"),
                           glow::Shader::fromFile(gl::FRAGMENT_SHADER, "data/arcsynthesis/chapter3/calc-color.frag")
                        );
