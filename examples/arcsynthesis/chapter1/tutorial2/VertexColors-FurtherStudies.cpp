...
protected:
    ...
    void initializeProgram () {
		...
		theProgram->attach(
                           glowutils::createShaderFromFile(GL_VERTEX_SHADER, "data/arcsynthesis/chapter1/tutorial2/vertex-colors-further-studies.vert"),
                           glowutils::createShaderFromFile(GL_FRAGMENT_SHADER, "data/arcsynthesis/chapter1/tutorial2/vertex-colors-further-studies.frag")
                           );
    }
